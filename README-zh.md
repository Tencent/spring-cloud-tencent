...
<dependencyManagement>
    <dependencies>
        <dependency>
            ...
            <!--version number-->
            <version>1.11.1-2020.0.6</version>
            <type>pom</type>
            <scope>import</scope>
        </dependency>
    </dependencies>
...
- [北极星控制台](http://14.22.2.220:80)
- 北极星服务端地址：`grpc://14.22.2.171:8091`

在 spring-cloud-tencent-example 项目里，北极星服务端地址默认配置为`grpc://14.22.2.171:8091`。
